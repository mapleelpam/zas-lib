...
package com.zillians.common.utilities
{
	 ...
	 * @version: 1.0
	 */
	public class StringTWLUtil
	{
		public function StringTWLUtil()
		{
			throw new Error("StringUtil class is static container only");
		}
		
		public static function hasSubString(str:String,substr:String):Boolean{
		...
		public static function isJsonStr(str:String):Boolean{
			if(beginsWith(str,"{")&&endsWith(str,"}")){
				return true;
			}
			return false;
		}
